...
let arrayStaticGroup = [
    ...
    ModelCategory(id: "42", name: "pdd-testy-rossii-gibdd", alias: "pdd-testy-rossii-gibdd", image: "images/categories/russ_test.png", parentId: "1", title: "ПДД тесты России (ГИБДД)", version: "1", test: [
        ModelTest(
            id: "1",
            name: "test1-rf-pdd",
            title: "1",
        ...
        ModelCategory(id: "8", name: "testy-pdd-kategoriya-a-b-m-rf-gibdd", alias: "testy-pdd-kategoriya-a-b-m-rf-gibdd", image: "images/categories/AB.png", parentId: "42", title: "Тесты ПДД категория \'A\'\'B\'\'M\'", version: "1", test: [], stackTest: [], modelCategory: []),
